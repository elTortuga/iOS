...
class ChildTableViewController: UITableViewController {
  ...
  let cities = ["El Centro", "San Francisco", "San Diego", "Cincinnati", "Albuquerque"]
  ...
  override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
    print("You selected city \(cities[indexPath.row])!")
    callDelegate(cities[indexPath.row])
  }
  
  func callDelegate(city:String) {
    delegate?.method(city)
  }
